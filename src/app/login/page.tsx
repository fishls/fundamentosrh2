...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    setLoading(true)
    // El formulario se enviará normalmente mediante el atributo 'action' 
    // pero queremos deshabilitar el botón inmediatamente.
    // Sin embargo, para Server Actions, podemos llamarlas manualmente o usar useFormStatus.
    // Para simplificar y mantener el diseño, dejaremos que el action fluya pero 
    // controlaremos el estado del botón.
  }
